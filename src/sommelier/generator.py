...
class Generator:
    ...
    def generate(self, job: Dict[str, Any], dry_run: bool = False) -> bool:
    ...
    def generate_all(self, config: Dict[str, Any], dry_run: bool = False) -> int:
        ...
        Args:
            config: Configuration dictionary with 'jobs' and optional 'template_dir'
            dry_run: If True, don't write files
        ...
        for i, job in enumerate(jobs, 1):
            ...
            if self.generate(job, dry_run=dry_run):
                successful += 1
